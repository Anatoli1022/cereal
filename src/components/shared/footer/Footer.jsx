      ...
      <div className={cx('footer-container', 'container')}>
        <div className={cx('form-wrapper')}>
          ...
          <form action='submit' className={cx('form')}>
            <input type='text' className={cx('input')} placeholder='youremail@mail.com' />
            <button type='button' className={cx('button-form')}>
              Submit
            </button>
        ...
        <div className={cx('wrapper-list')}>
          ...
          <p className={cx('text')}>
            Cereal is a biannual, travel & style magazine based in the United Kingdom. Each issue focusses on a select
            number of destinations, alongside engaging interviews and stories on unique design, art, and fashion.
          </p>
        </div>
      </div>
    </footer>
